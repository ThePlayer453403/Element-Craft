...
public class ModComponents {
    ...
    public static final DeferredHolder<DataComponentType<?>, DataComponentType<Integer>> ORIGINAL_RESIN_AMOUNT = register("original_resin_replenished", builder -> builder.persistent(Codec.INT));
